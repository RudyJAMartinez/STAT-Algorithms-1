...
setwd("/Users/rudymartinez/Desktop/MSDA/Fall 2020/STA 6443_Algorithms I/STAT-Algorithms-1/Week 8")
...
##############################################################
# scatter plot and correlation between alcohol and cirrhosis
##############################################################
# scatter plot
...
with(drinking, plot(alcohol, cirrhosis))
abline(lm.drinking, col="red")
abline(lm.drinking2,col="blue")
legend("bottomright",col=c(1,2),legend=c("w/ France", "w/out France"), cex=0.8, title.adj=0.15)
